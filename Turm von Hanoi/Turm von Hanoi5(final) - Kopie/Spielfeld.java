...
public class Spielfeld extends World
{
    ...
    public int test(int n){
        int Induktionsschritt = sortzuege(n+1);
        zurück(); 
        
        int ergebnis = 2*sortzuege(n)+1;
        
         if(Induktionsschritt == ergebnis){
    ...
    public void zurück(){
    sortieren(zielturm,startturm,anzahlSteine);
    }

    public int sortzuege(int anzahlsteine){
        anzahlzuege = 0;
        
        sortieren(startturm, zielturm, anzahlsteine);
