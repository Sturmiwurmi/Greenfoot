...
/**
 * Write a description of class Turm310 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Turm310 extends World
{
    ...
    {    
        ...
        this.addObject(new Treppe310zu320(), 19, 6);

        this.addObject(new Treppe310zuE(), 19, 8);
    ...
    private void prepare()
    {
        ...
        HerrSchickert herrSchickert = new HerrSchickert();
        addObject(herrSchickert,8,1);
        Kreide kreide = new Kreide();
        addObject(kreide,9,2);
        Raum313 raum313 = new Raum313();
        addObject(raum313,7,5);
        Kreide kreide2 = new Kreide();

        Kreide2 kreide3 = new Kreide2();
        addObject(kreide3,10,12);
        kreide3.setRotation(180);
    }
}
