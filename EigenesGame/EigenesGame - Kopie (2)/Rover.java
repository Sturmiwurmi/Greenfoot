...
public class Rover extends Actor
{
    ...
    public void S33Nr1 ()
      ...
      public void analysiereFünfmalFünf ()
       {
         ...
         public void fahreVier ()
       {
          ...
          public void fahreDrei ()
       {
           fahre();
           fahre();
           fahre();
        }
          public void fahreZwei ()
       {
           fahre();
           fahre();
           
        }
         public void erschaffeBerg()
         {
            getWorld().addObject(new Huegel(), 3, 3);
            getWorld().addObject(new Huegel(), 4, 2);
            getWorld().addObject(new Huegel(), 3, 4);
            getWorld().addObject(new Huegel(), 5, 2);
            getWorld().addObject(new Huegel(), 6, 3);
            getWorld().addObject(new Huegel(), 7, 4);
            getWorld().addObject(new Huegel(), 6, 5);
            getWorld().addObject(new Huegel(), 5, 3);
            getWorld().addObject(new Huegel(), 4, 4);
            getWorld().addObject(new Huegel(), 3, 3);
            getWorld().addObject(new Huegel(), 5, 4);
            getWorld().addObject(new Huegel(), 4, 5);
            getWorld().addObject(new Huegel(), 4, 3);
            getWorld().addObject(new Huegel(), 6, 4);
