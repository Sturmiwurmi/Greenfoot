...
public class Turm420 extends World
{
    ...
    public Turm420()
    {
        ...
        this.addObject(new Treppe420zu410(), 19, 7);
    ...
    private void prepare()
    {
        ...
        HerrHeimann herrHeimann = new HerrHeimann();
        addObject(herrHeimann,11,13);
        Raum421 raum421 = new Raum421();
        addObject(raum421,14,9);
        Raum421 raum4212 = new Raum421();
        addObject(raum4212,11,7);
        removeObject(raum4212);
        Raum424 raum424 = new Raum424();
        addObject(raum424,14,5);
    }
}
